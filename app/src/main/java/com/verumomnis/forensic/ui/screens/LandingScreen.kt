...
fun LandingScreen(nav: NavController) {
    Column(modifier = Modifier.fillMaxSize().padding(16.dp)) {
        ...
        VerumSectionCard("Begin Analysis") { nav.navigate("role") }
        VerumSectionCard("Legal Advice") { nav.navigate("legal") }
        VerumSectionCard("Tax Returns (50% cheaper)") { nav.navigate("tax") }
    }
}
